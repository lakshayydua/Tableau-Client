...
if __name__ == '__main__':
    ...
    if CHUNKED:
        ...
        print("\nPublishing the workbook '{0}' to the server as 'PublishedWithRestAPIWorkBook' using the chunked method ...".format(WORKBOOK_NAME))
        ...
        print("Publishing the workbook '{0}' to the server as 'PublishedWithRestAPIWorkBook' using the all-in-one method ...".format(WORKBOOK_NAME))
